...
export const appwriteConfig = {
  ...
  liveStreamsCollectionId: "live_streams", // You'll need to create this collection
  liveCommentsCollectionId: "live_comments", // You'll need to create this collection
  liveReactionsCollectionId: "live_reactions", // You'll need to create this collection
};
